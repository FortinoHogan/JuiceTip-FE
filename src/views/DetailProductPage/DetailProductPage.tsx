      ...
      {product &&
        <div>
          ...
          <div className="bg-e5e5e5 flex items-center mt-5 flex-col gap-20 min-h-screen py-14">
            <h1 className="text-center text-10b981 font-bold text-5xl">PRODUCT DETAIL</h1>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex flex-col w-full">
                  <div className="flex items-center justify-between relative">
                    <h1 className="text-10b981 font-bold text-4xl">{product.productName}</h1>
                    <p className="text-b5b8b9 font-bold text-md absolute right-0 bottom-0">
                      Uploded at <span>{format_d_mm_yy(product.createdAt)}</span>
                    </p>
                  </div>
                  <hr className="h-0.5 mt-3 bg-gray-200 border-0 bg-bcbec0 rounded-sm" />
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between my-2">
                      <h1 className="text-8c8c8c font-bold text-2xl">{product.regionName}</h1>
                      <div className="flex py-2 px-4 items-center bg-e5e5e5 gap-3 rounded-md">
                        <img
                          ...
                          className="w-8"
                        />
                        <p className="text-8c8c8c font-bold text-xl">{product.productPrice}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 mt mb-2">
                      ...
                      />
                      <div className="flex flex-col">
                        <h1 className="text-8c8c8c font-bold text-xl">{product.customerName}</h1>
                        <p className="text-8c8c8c font-bold text-md">
                          Last Updated <span>{format_last_updated(product.lastUpdatedAt)}</span>
                        </p>
                      </div>
                    </div>
